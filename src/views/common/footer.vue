<template>
  <div class="footer">
    ...
    <div class="copy">
      <p>
        Copyright ©杭州瑔石信息咨询有限公司All rights
      ...
      <p>
        以上项目皆真实，信息来自信托、基金、保险等金融机构，其对提供信息的真实可靠性和完整准确性负责投资者应仔细阅读产品的法律文件，了解产品风险和收益特征(包括系统性风险和特定产品所特有的投资风险等)。
      </p>
    </div>
  </div>
</template>
  ...
  .footer {
    ...
    .footerRight {
      ...
      .footerIntro {
        ...
        padding: 30px 28px;
        box-sizing: border-box;
        background-image: url(/img/foottitlebg.png);
        ...
        p {
          ...
          color: #eecf98;
          line-height: 24px;
          text-shadow: 0px 2px 3px #202123;
          margin: 0;
          line-height: 2;
          margin-top: 20px;
        }
